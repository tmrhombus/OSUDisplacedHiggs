...
import copy
import string
from OSUDisplacedHiggs.ZEEChannel.CutDefinitions import *
...
ZControlRegion.cuts.append(electron_pt_30_cut)
...
ZControlRegion.cuts.append(diElectron_invElectron_Z_cut)
