...
jet_FSU_cut = cms.PSet(
    inputCollection = cms.vstring("jets"),
    cutString = objectDefs.jet_FSU_cutstring,
    numberRequired = cms.string(">= 1"),
    )
...
#
FSUcut = cms.PSet(
    name = cms.string("FSUcut"),
    triggers = eetrigger,
    cuts = cms.VPSet()
)

FSUcut.cuts.append(jet_pt_20_cut)
FSUcut.cuts.append(jet_eta_cut)
FSUcut.cuts.append(jet_FSU_cut)
